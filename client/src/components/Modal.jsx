...
export default function Modal({ isOpen, onClose, title, children, size = 'md' }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className={`relative bg-white border border-dark-700 rounded-2xl shadow-xl w-full ${sizes[size]} max-h-[90vh] flex flex-col`}>
        {title && (
          <div className="flex items-center justify-between p-5 border-b border-dark-700 flex-shrink-0">
            <h2 className="text-dark-50 font-semibold text-lg">{title}</h2>
